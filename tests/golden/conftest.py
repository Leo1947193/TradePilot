...
@pytest.fixture
def make_module_results() -> Callable[..., ModuleResults]:
    def _make_module_results(**overrides: object) -> ModuleResults:
        payload = {
            "technical": {
                "status": "usable",
                "direction": "neutral",
                "data_completeness_pct": 100,
                "summary": "Technical view is balanced.",
            },
            "fundamental": {
                "status": "usable",
                "direction": "neutral",
                "data_completeness_pct": 100,
                "summary": "Fundamental view is balanced.",
            },
            "sentiment": {
                "status": "usable",
                "direction": "neutral",
                "data_completeness_pct": 100,
                "summary": "Sentiment view is balanced.",
            },
            "event": {
                "status": "usable",
                "direction": "neutral",
                "data_completeness_pct": 100,
                "summary": "Event view is balanced.",
            },
        }
        payload.update(overrides)
        return ModuleResults.model_validate(payload)

    return _make_module_results
